---
title: "Automating Android development"
author: "Enrique López-Mañas"
date: 2015-05-05T05:58:00.057Z
lastmod: 2025-06-09T09:47:52+02:00

description: ""

subtitle: "Achieve more by doing less"

image: "/articles/2015-05-05_automating-android-development/images/1.png" 
images:
 - "/articles/2015-05-05_automating-android-development/images/1.png"
 - "/articles/2015-05-05_automating-android-development/images/2.png"
 - "/articles/2015-05-05_automating-android-development/images/3.png"
 - "/articles/2015-05-05_automating-android-development/images/4.png"
 - "/articles/2015-05-05_automating-android-development/images/5.png"
 - "/articles/2015-05-05_automating-android-development/images/6.png"
 - "/articles/2015-05-05_automating-android-development/images/7.png"
 - "/articles/2015-05-05_automating-android-development/images/8.png"
 - "/articles/2015-05-05_automating-android-development/images/9.png"
 - "/articles/2015-05-05_automating-android-development/images/10.png"


aliases:
    - "/automating-android-development-6daca3a98396"
...
As a software engineer, your aim is to automate as many processes as possible. Machines are more efficient than people: they do not need food neither sleep, they perform tasks errorless and they make your life easier. _Work hard in order to work less_.
...
I am using a fork of a branching strategy proposed by [Vincent Driessen](http://nvie.com/posts/a-successful-git-branching-model/), slightly modified. Let’s consider three states for our application: **alpha**, **beta** and **release**.
...
![image](/articles/2015-05-05_automating-android-development/images/1.png#layoutTextWidth)
...
![image](/articles/2015-05-05_automating-android-development/images/2.png#layoutTextWidth)
...
_[FEATURE-123] Created a new screen that performs an action._

![image](/articles/2015-05-05_automating-android-development/images/3.png#layoutTextWidth)
...
![image](/articles/2015-05-05_automating-android-development/images/4.png#layoutTextWidth)
...
![image](/articles/2015-05-05_automating-android-development/images/5.png#layoutTextWidth)
...
![image](/articles/2015-05-05_automating-android-development/images/6.png#layoutTextWidth)
...
I wrote previously a [post](http://codetalk.de/?p=112) with some tricks to use Gradle. Some of them will be useful to include in your application, but there are a few more I have been applying since then, and I would like to introduce here.

#### The power of BuildConfig

_BuildConfig_ is a file generated automatically when we compile an Android application. This file, by default, looks like follows:

![image](/articles/2015-05-05_automating-android-development/images/7.png#layoutTextWidth)
...
To show a basic example on how tests are integrated in Jenkins (and how they achieve a function of stopping a build when something goes wrong) we will show a small example of a UI Test done with [Espresso](https://code.google.com/p/android-test-kit/wiki/Espresso) that tests our Android application each time is built in Jenkins.

### An example application

I have created a small example application and uploaded it to [GitHub](https://github.com/kikoso/Android-Testing-Espresso), so you can check it out there. There are are also some branches with a naming convention and pull requests you can see there to review everything explained until now. The application is fairly basic: it has a screen with a TextView. There are also three UI Tests been performed in the file [MainActivityInstrumentationTest](https://github.com/kikoso/Android-Testing-Espresso/blob/master/src/androidTest/java/com/dropsport/espressoreadyproject/tests/MainActivityInstrumentationTest.java):
...
If you check out the code, you can try it by yourself uncommenting the function _testFalseLabel_. That will make the tests fail.
...
![image](/articles/2015-05-05_automating-android-development/images/9.png#layoutTextWidth)
...
![image](/articles/2015-05-05_automating-android-development/images/10.png#layoutTextWidth)
...
Achieving automation in _building_, _testing_, _delivering_ and _publishing_ is mainly a matter of choosing a right set of policies to work with a team. When this policies are well defined, we can proceed to the technical implementation.
