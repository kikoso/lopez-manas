...
date = "2022-05-25"
tags = ["kmp", "android", "kotlin", "kotlin-native"]
images = []
+++

![](https://cdn-images-1.medium.com/max/1024/1*uz-uJJLVLZEVx5FBImJQWw.jpeg)
...
![](https://cdn-images-1.medium.com/max/431/1*_snbqlBcEr1Q3G65O0r54A.png)
...
![](https://cdn-images-1.medium.com/max/1024/1*L2JSnl9v3nh3gnBS4nJrnw.png)

*Almost half of KMM users (48.4%) share more than half of their codebase.*

![](https://cdn-images-1.medium.com/max/1024/1*2kvGr_WIso0tLv7LoFoPnA.png)
...
![](https://cdn-images-1.medium.com/max/1024/1*C846vfzbUr06L4JjY04z4g.png)

If we do not specify the parameter nice, the default will be taken instead:

![](https://cdn-images-1.medium.com/max/806/1*NnwvdyigkGxFUSVbq04N4Q.png)
...
![](https://cdn-images-1.medium.com/max/1024/1*8v1XrLImdEM-OIBP7Ro13Q.png)
