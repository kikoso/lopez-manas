---
title: "A Gentle Introduction to Investing for Software Engineers (IV) — My methodology to determine which…"
author: "Enrique López-Mañas"
date: 2019-12-05T04:10:01.253Z
lastmod: 2025-06-09T09:49:32+02:00

description: ""

subtitle: "In this fourth and last article of the series, I will explain my methodology to acquire individual stock in the market. Most of the…"

image: "/articles/2019-12-05_gentle-introduction-to-investing-for-software-engineers-ivmy-methodology-to-determine-which/images/1.jpeg" 
images:
 - "/articles/2019-12-05_gentle-introduction-to-investing-for-software-engineers-ivmy-methodology-to-determine-which/images/1.jpeg"
 - "/articles/2019-12-05_gentle-introduction-to-investing-for-software-engineers-ivmy-methodology-to-determine-which/images/2.png"
 - "/articles/2019-12-05_gentle-introduction-to-investing-for-software-engineers-ivmy-methodology-to-determine-which/images/3.png"
 - "/articles/2019-12-05_gentle-introduction-to-investing-for-software-engineers-ivmy-methodology-to-determine-which/images/4.png"
 - "/articles/2019-12-05_gentle-introduction-to-investing-for-software-engineers-ivmy-methodology-to-determine-which/images/5.png"
 - "/articles/2019-12-05_gentle-introduction-to-investing-for-software-engineers-ivmy-methodology-to-determine-which/images/6.png"
 - "/articles/2019-12-05_gentle-introduction-to-investing-for-software-engineers-ivmy-methodology-to-determine-which/images/7.jpeg"
 - "/articles/2019-12-05_gentle-introduction-to-investing-for-software-engineers-ivmy-methodology-to-determine-which/images/8.png"
 - "/articles/2019-12-05_gentle-introduction-to-investing-for-software-engineers-ivmy-methodology-to-determine-which/images/9.png"
 - "/articles/2019-12-05_gentle-introduction-to-investing-for-software-engineers-ivmy-methodology-to-determine-which/images/10.png"


aliases:
    - "/a-gentle-introduction-to-investing-for-software-engineers-iv-my-methodology-to-determine-which-2197c19f4486"
...
[(II) — Compounding interest and introducing other factors](https://enriquelopezmanas.medium.com/a-gentle-introduction-to-investing-for-software-engineers-ii-compounding-interest-and-efdfdc3dbafd)

[(III) — Determining a company value and acquisition point](https://enriquelopezmanas.medium.com/a-gentle-introduction-to-investing-for-software-engineers-iii-determining-a-company-value-and-9874ac49ef62)

[(IV) — My methodology to determine which stock to buy](https://enriquelopezmanas.medium.com/a-gentle-introduction-to-investing-for-software-engineers-iv-my-methodology-to-determine-which-2197c19f4486)
...
![image](/articles/2019-12-05_gentle-introduction-to-investing-for-software-engineers-ivmy-methodology-to-determine-which/images/2.png#layoutTextWidth)

![image](/articles/2019-12-05_gentle-introduction-to-investing-for-software-engineers-ivmy-methodology-to-determine-which/images/3.png#layoutTextWidth)
...
![image](/articles/2019-12-05_gentle-introduction-to-investing-for-software-engineers-ivmy-methodology-to-determine-which/images/4.png#layoutTextWidth)
...
The motivation for this is to diversify and protect ourselves from the [Concorde Fallacy](https://brickstartup.co/beware-of-the-concorde-fallacy-d8462d3449d4#:~:targetText=The%20Concorde%20fallacy%2C%20also%20known,economic%20case%20for%20the%20aircraft.&amp;targetText=The%20more%20we%20invest%20in,is%20to%20let%20it%20go.). The main problematic impediment for investors is our own psychology, and when a stock looks cheap, we might be tempted to keep over-investing in it. If the stock keeps sinking, this can result in looses or a [missed opportunity](https://www.inc.com/encyclopedia/opportunity-cost.html#:~:targetText=Opportunity%20Cost,a%20concept%20used%20in%20economics.). Over my investing lifetime, I have realised that there are always many stocks that are cheap at a single time. Diversify by specifying a maximum percentage you want for each stock — and at the same time, do not obsess too much about it.
...
As I mentioned in my previous article, the [Price to Earnings Ratio](https://medium.com/@enriquelopezmanas/a-gentle-introduction-to-investing-for-software-engineers-iii-determining-a-company-value-and-9874ac49ef62) (or PER) is the measure of the share **price** relative to the annual net income earned by the firm per share. In a nutshell: it shows us “how much we pay in order to earn money”. There is no unique number that specifies what a good (cheap) PER is and what is not. In some literacy, 15 is taken as the standard value for PER (neither cheap or expensive), but this is a wrong measurement. PER should be considered as follows:
...
![image](/articles/2019-12-05_gentle-introduction-to-investing-for-software-engineers-ivmy-methodology-to-determine-which/images/5.png#layoutTextWidth)
[https://www.macrotrends.net/stocks/charts/GIS/general-mills/pe-ratio](https://www.macrotrends.net/stocks/charts/GIS/general-mills/pe-ratio)
...
![image](/articles/2019-12-05_gentle-introduction-to-investing-for-software-engineers-ivmy-methodology-to-determine-which/images/6.png#layoutTextWidth)
...
![image](/articles/2019-12-05_gentle-introduction-to-investing-for-software-engineers-ivmy-methodology-to-determine-which/images/7.jpeg#layoutTextWidth)
...
![image](/articles/2019-12-05_gentle-introduction-to-investing-for-software-engineers-ivmy-methodology-to-determine-which/images/8.png#layoutTextWidth)
...
![image](/articles/2019-12-05_gentle-introduction-to-investing-for-software-engineers-ivmy-methodology-to-determine-which/images/9.png#layoutTextWidth)
...
![image](/articles/2019-12-05_gentle-introduction-to-investing-for-software-engineers-ivmy-methodology-to-determine-which/images/10.png#layoutTextWidth)
...
I do periodic contributions to my portfolio. I reinvest the dividends as they come (normally putting them together to make bigger acquisitions), and I do monthly transfers to my broker at the beginning of the month, following the principle [Pay yourself first](https://www.investopedia.com/terms/p/payyourselffirst.asp#:~:targetText=Pay%20Yourself%20First%20is%20a,or%20discretionary%20purchases%20are%20made.). Every extra cash flow I receive from different sources is automatically sent to the broker. In fact, I do not keep too much in cash — something between 6–10 months of living expenses. This approach was scary at first, but it has helped to grow the snowball more than I was expecting when I started. Over time, the passive income has grown to a point where it covers most of my expenses.
...
I cannot analyze all the companies in the market — that would be unfeasible. So I rely on other sources. I have added my portfolio to [Seeking Alpha](https://seekingalpha.com/), and there are a few investors I follow there, and I read their analysis. Their analyses do not necessarily convert into a buy from my side, but I read them with attention.

There are some individual folks I follow and chat with. There is a huge Spanish community I have the pleasure to belong. I check the analysis of [Snowball](https://medium.com/@eloygomor/resumen-y-seguimiento-noviembre-2019-incluye-csco-dge-xom-y-bep-6d45598f6ce5), [Capturando Dividendos](http://capturandodividendos.blogspot.com/) and [Gregorio](https://www.invertirenbolsa.info/foro-inversiones/member.php?1-Invertirenbolsa). There are some channels where we communicate (forums, Telegram groups and Twitter), and we exchange ideas.
